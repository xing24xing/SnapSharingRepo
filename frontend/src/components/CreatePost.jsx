...
const CreatePost = ({ open, setOpen }) => {
    ...
    return (
        <Dialog open={open}>
            <DialogContent onInteractOutside={() => setOpen(false)} aria-describedby="create-post-description">
                <DialogHeader>
                    <DialogTitle className='text-center font-semibold'>Create New Post</DialogTitle>
                    <DialogDescription id="create-post-description">Share Your Moments..</DialogDescription>
                </DialogHeader>
